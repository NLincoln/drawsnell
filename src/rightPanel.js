...
export default function RightPanel(props) {
  ...
  function makeLayerSolo(layNum) {
    props.mainComp.layers[layNum].isSolo = !props.mainComp.layers[layNum]
      .isSolo; // invert whether solo or not
  ...
  */
  ...
  function deleteSelectedPixels() {
    ...
    for (let ii = 0; ii < props.activeLayers.length; ii++) {
      ...
      } // if(props.selection.magicWandSelectedPixels != null) // strict else may be safer
      else {
  ...
  ///////////////////////////////
  function LayerItem(param) {
    // param corresponds to the index of the layer in question
  ...
  function LayerList(props) {
    ...
    for (
      let i = 1;
      i < props.mainComp.layers.length;
      i++ // layer at index 0 is NOT a true layer the user can manage
    ) {
      numbers.push(i);
    }
  ...
  return (
    <PanelWrapper>
      ...
      Active Layers ={" "}
      {props.mainComp.getLayerNamesStringFromArrayOfIndices(props.activeLayers)}
      <br />
